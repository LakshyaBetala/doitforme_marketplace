   ...
   return (
      <div className="min-h-screen bg-[#0B0B11] text-white p-6 md:p-12 selection:bg-[#8825F5] selection:text-white">
         ...
         <div className="max-w-4xl mx-auto text-center space-y-12">
            ...
            <div>
               <h1 className="text-4xl md:text-5xl font-black tracking-tight mb-4">DoItForMe Pricing – Transparent & Student-Friendly</h1>
            ...
            <div className="mt-12 bg-white/5 border border-white/10 rounded-2xl p-6 text-center max-w-2xl mx-auto">
               ...
               <p className="text-white/50 text-sm">
                  Contact us at <a href="mailto:doitforme.in@gmail.com" className="text-[#8825F5] font-medium hover:underline">doitforme.in@gmail.com</a> or call <a href="tel:+919344110272" className="text-green-500 font-medium hover:underline">+91 93441 10272</a>
               </p>
            </div>
