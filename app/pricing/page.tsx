         ...
         <div className="max-w-4xl mx-auto text-center space-y-12">
            ...
            <div className="mt-12 bg-white/5 border border-white/10 rounded-2xl p-6 text-center max-w-2xl mx-auto">
               ...
               <p className="text-white/50 text-sm">
                  Contact us at <a href="mailto:doitforme@gmail.com" className="text-[#8825F5] font-medium hover:underline">doitforme@gmail.com</a> or call <a href="tel:+919344110272" className="text-green-500 font-medium hover:underline">+91 93441 10272</a>
               </p>
            </div>
