...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with DoItForMe support for help with tasks, payments, disputes, or general queries. Email doitforme.in@gmail.com, or gandhimouriyan1234@gmail.com for billing and escalations. Based in Chennai, India.",
