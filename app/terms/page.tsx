...
export const metadata: Metadata = {
  ...
  description:
    "Read DoItForMe's Terms & Conditions. Covers user accounts, KYC verification, protected payments, platform fees (5% on student listings, 10% on company tasks), prohibited activities, and dispute resolution.",
