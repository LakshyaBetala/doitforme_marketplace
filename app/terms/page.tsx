...
export const metadata: Metadata = {
  ...
  description:
    "Read DoItForMe's Terms & Conditions. Covers user accounts, KYC verification, escrow payments, platform fees (0% for posters, 10% for workers), prohibited activities, and dispute resolution.",
